      ...
      <section className="w-full lg:w-1/2 mt-2 lg:mt-0 px-2">
        ...
        <div className="panel">
          ...
          <div className="mt-4 flex space-x-4">
            <Button className="" type="primary" disabled={false}>
              Click me
            </Button>
            <Button className="" type="primary" busy={true}>
              Click me
            </Button>
            <Button className="" type="primary" disabled={true}>
              Click me
            </Button>
          </div>
          <div className="mt-4 flex space-x-4">
            <Button
              className=""
              type="secondary"
              _onClick={handleClickPromiseResolve}
            >
              Click me
            </Button>
            <Button className="" type="secondary" busy={true}>
              Click me
            </Button>
            <Button className="" type="secondary" disabled={true}>
              Click me
            </Button>
          </div>
          <div className="mt-4 flex space-x-4">
            <Button className="" _onClick={handleClickPromiseReject}>
              Click me
            </Button>
